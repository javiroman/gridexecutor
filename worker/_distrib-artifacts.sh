...
icegridadmin --Ice.Config=../broker/gridlocator.cfg -u grid -p xxx -e 'server stop GridExecutorApp.IcePatch2'
# 2. Decimos al registry que queremos parchear la aplicacion con nuevos componetes.
icegridadmin --Ice.Config=../broker/gridlocator.cfg -u grid -p xxx -e 'application patch -f GridExecutorApp'
